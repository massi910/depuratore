...
{
    var current = new models.Money(0);
    ...
    $.ajax({
        ...
        success: function (response) 
        {
            ...
            for (var i = 0; i < len; i++) {
                ...
                var newItem = new models.PvItem(id, name, description, price, section);
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            for (var i = 0; i < len; i++) {
                ...
                pvSectionsMap.set(id, new models.PvSection(id, name, description, pvItemsMap.get(id), mandatory));
            }   
        }
    });
});
